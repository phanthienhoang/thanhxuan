        ...
        <div class="container-fluid" style=" background-color: #fff; padding: 11px;">
            <div class="row">
                <div class="col-lg-2 order-lg-1 order-2">
                    <ul class="image_list">
                        <li data-image="{{ asset('thanhxuan/assets/images/product/product-01.png') }}"><img src="{{ asset('thanhxuan/assets/images/product/product-01.png') }}" alt=""></li>
                        <li data-image="{{ asset('thanhxuan/assets/images/product/product-01.png') }}"><img src="{{ asset('thanhxuan/assets/images/product/product-01.png') }}" alt=""></li>
                        <li data-image="{{ asset('thanhxuan/assets/images/product/product-01.png') }}"><img src="{{ asset('thanhxuan/assets/images/product/product-01.png') }}" alt=""></li>
                    </ul>
                </div>
                <div class="col-lg-4 order-lg-2 order-1">
                    <div class="image_selected"><img src="{{ asset('thanhxuan/assets/images/product/product-01.png') }}" alt=""></div>
                </div>
